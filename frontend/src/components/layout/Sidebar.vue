<template>
  <aside class="sidebar" :class="{ 'sidebar--collapsed': collapsed }">
    ...
    <nav class="nav">
      ...
      <router-link to="/facturacion" class="nav-item" active-class="nav-item--active" :title="collapsed ? 'Facturación' : ''">
        <svg class="nav-icon" viewBox="0 0 24 24" fill="currentColor">
          <path d="M19 2H5c-1.11 0-2 .9-2 2v16c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 18H5V4h14v16zM7 6h10v2H7zm0 4h10v2H7zm0 4h7v2H7z"/>
        </svg>
